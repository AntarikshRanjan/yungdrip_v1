...
export function requestPasswordReset(payload) {
  return sendJson("/api/auth/forgot-password", { body: payload });
}

export function resetPassword(payload) {
  return sendJson("/api/auth/reset-password", { body: payload });
}

export function fetchServerCart() {
  return sendJson("/api/cart", { method: "GET" });
}

export function saveServerCart(payload) {
  return sendJson("/api/cart", { method: "PUT", body: payload });
}

export function mergeServerCart(payload) {
  return sendJson("/api/cart", { method: "POST", body: payload });
}
